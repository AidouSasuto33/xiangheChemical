# production/services/cvn_stripping_service.py
...
class CVNStrippingService(BaseProcedureService):
    """
    CVN 粗蒸工艺服务层
    极致纯净的子类，所有核心业务逻辑（含粗蒸前质检提取、前置批次溯源扣减等）
